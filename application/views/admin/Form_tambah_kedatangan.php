          ...
          <div class="card bg-light border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4 text-primary">
                <h2 style="text-shadow: 3px 2px 5px grey;"><b>FORM TAMBAH DATA KEDATANGAN</b></h2>
              </div>


              
              <!--Form--> 
              <form role="form" method="POST" action="<?php echo site_url('Perangkat/Proses_Tambah_Kedatangan'); ?>">

                <div class="form-group">
                
                    <input class="form-control" placeholder="Id Kedatangan" name="no_datang" type="hidden">
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Tanggal Datang" name="tgl_datang" type="date" required>
                  </div>
                </div>

    ...
    <div class="row">
        <?php foreach($event as $kegiatan) { ?>
            <div class="col-12 col-md-4 col-lg-4">
                <a href="<?= site_url('Masyarakat/Detail_Event/'.$kegiatan->no_event) ?>" class="text-decoration-none">
                    <article class="article article-style-c">
                        <div class="card" style="width: 20rem;">
                            <img class="card-img-top" src="<?php echo base_url().'/gambarevent/'.$kegiatan->gambar ?>" alt="Card image cap" style="height: 200px; object-fit: cover;">
                            <div class="card-body">
                                <p class="card-text" style="color:black;">
                                    <b><?php echo $kegiatan->judul_event ?></b><br><br>
                                    <?php echo substr($kegiatan->isi_event, 0, 100) ?>...<br><br>
                                </p>
                            </div>
                        </div>
                    </article>
